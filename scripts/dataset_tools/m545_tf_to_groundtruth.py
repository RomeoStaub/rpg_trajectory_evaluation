...
def write_transformation_to_txt_file(bag_file, target_frame, source_frame,
                                     txt_file_name):
  ...
  print("Looking up transforms and writing to txt file...")
  for topic, msg, t in bag.read_messages():
    #print("topic_",topic, "message transorms", msg.transforms)
    if (topic == "/tf" or topic == "tf" ) and msg.transforms:
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--txt_output_file', required=True, help='Path to output txt file')

  args = parser.parse_args()

  print("tf_to_txt.py: export tf to txt from bag: ", args.bag, "...")

  write_transformation_to_txt_file(args.bag, args.tf_target_frame,
                                   args.tf_source_frame,
                                   args.txt_output_file)
