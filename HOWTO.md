...
There are some scripts under `hand_eye_calibration` to help you convert your data format to the above format.
...
```
rosrun rpg_trajectory_evaluation analyze_trajectory_single.py ~/catkin_ws/src/rpg_trajectory_evaluation/results/m545
```
